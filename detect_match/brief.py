...
star = cv2.FastFeatureDetector_create(threshold=20, nonmaxSuppression=True,type=cv2.FAST_FEATURE_DETECTOR_TYPE_9_16)

# 初始化BRIEF特征提取器
brief = cv2.xfeatures2d.BriefDescriptorExtractor_create()
# 使用STAR寻找特征点
kp_ori = star.detect(img_ori_gray,None)
kp_rotate = star.detect(img_rotate_gray,None)

# kp 关键点， des 描述子
kp_ori, des_ori = brief.compute(img_ori, kp_ori)
kp_rotate, des_rotete = brief.compute(img_rotate, kp_rotate)
...
def matching(match_func, ratio=0.9):
